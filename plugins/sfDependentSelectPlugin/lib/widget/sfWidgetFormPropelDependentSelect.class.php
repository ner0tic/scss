 ...
 * SelectDependiente javascript class optimized for propel objects.
 *
 * @package    symfony
 * @subpackage widget
 * @author     Sergio Flores <sercba@gmail.com>
 */
class sfWidgetFormPropelDependentSelect extends sfWidgetFormObjectDependentSelect
{
   /**
    * Constructor.
    *
    ...
    */
    ...
    {
        $options['source_class'] = 'sfDependentSelectPropelSource';
