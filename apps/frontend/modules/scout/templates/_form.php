...
<div class="form-wrapper" id="scout-form-wrapper">
  <div class="form-content-wrapper">
    ...
    <form id="scout-form" action="<?php echo url_for('scout/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : ''),array('district_slug'=>$sf_request->getParameter('district_slug'),'troop_slug'=>$sf_request->getParameter('troop_slug'))) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
      <div>      
