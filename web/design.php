...
<body>
    <div id="header">
        <div class="container">
            <ul id="top-links">
                <li id="active-enrollment">
                    <span id="change-active-troop">
                        <a href="#" class="active-troop"><span>ner0tic&nbsp;<em>as</em>&nbsp;CB&nbsp;805&nbsp;</span></a>
                    </span>
                    <fieldset id="active-enrollment-menu">
                        <h3>Change Active Enrollment Information</h3>
                            <?php //$activeForm = new ChangeActiveEnrollmentForm();echo $activeForm; ?>
                        <input type="submit" class="orangeButton" value="Change" />
                    </fieldset>
                </li>

                <!--<li id="active-enrollment"><a href="/profile">ner0tic</a>&nbsp;as&nbsp;<a href="/troops/cb805">CB&nbsp;805</a></li> -->
                <li><a href="/help/dashboard">Help</a></li>
            ...
            <div class="nav-bar">
                <ul>
                    ...
                    <li><a href="/enrollment/scouts">scout enrollment</a></li>
                    <li><a href="/enrollment/troops">troop registration</a></li>
    ...
    <div id="main-content" class="container">
        ...
        <div id="footer">
            <div class="copyright">&copy; 2010 SCSS; all rights reserved</div>
            <div class="footer-links"><span class="about-tab">About SCSS</span>&nbsp;|&nbsp;<span class="privacy-tab">Privacy Policy</span>&nbsp;|&nbsp;<span class="donate-tab">Donate</span></div>
        </div>
