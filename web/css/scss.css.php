...
h2 { font-size : 24px; color : <?php echo $logoDark ?>; font-weight : normal; margin: 0;}
...
#info-box em, #info-box strong { color: #666; float: right; font-style: normal; margin-top: 3px; }
#info-box hr { background: <?php echo $gold ?>; border: none; border-bottom: 1px solid #ltGold; height: 1px; margin: 7px 0; }
