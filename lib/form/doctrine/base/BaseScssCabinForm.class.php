...
/**
 * ScssCabin form base class.
 *
 * @method ScssCabin getObject() Returns the current form's model object
 *
 * @package    scss
 * @subpackage form
 * @author     David Durost
 ...
 */
abstract class BaseScssCabinForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'ScssCabin', 'column' => array('slug')))
    );

    $this->widgetSchema->setNameFormat('scss_cabin[%s]');
