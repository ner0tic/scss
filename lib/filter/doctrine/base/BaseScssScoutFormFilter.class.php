...
/**
 * ScssScout filter form base class.
 *
 * @package    scss
 * @subpackage filter
 * @author     David Durost
 ...
 */
abstract class BaseScssScoutFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'patrol_id'  => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Patrol'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'patrol_id'  => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Patrol'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('scss_scout_filters[%s]');
