...
/**
 * ScssCampsite filter form base class.
 *
 * @package    scss
 * @subpackage filter
 * @author     David Durost
 ...
 */
abstract class BaseScssCampsiteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('scss_campsite_filters[%s]');
