...
require_once('/home/ner0tic/symfony_projects/scss/trunk/plugins/sfAssetsManagerPlugin/lib/config/sfAssetsManagerConfigHandler.class.php');
...
$this->handlers['config/assets_manager.yml'] = new sfAssetsManagerConfigHandler();
