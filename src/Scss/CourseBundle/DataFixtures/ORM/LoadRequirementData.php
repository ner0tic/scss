<?php
  ...
  class LoadRequirementData extends AbstractFixture implements OrderedFixtureInterface {
    public function load(ObjectManager $manager) {
      ...
      $CAMPING_1->setMeritBadge($this->getReference('camping'));      
      ...
      $CAMPING_2->setMeritBadge($this->getReference('camping'));
      ...
      $CAMPING_3->setMeritBadge($this->getReference('camping'));      
      ...
      $CAMPING_4->setMeritBadge($this->getReference('camping'));
      ...
      $CAMPING_4a->setMeritBadge($this->getReference('camping'));      
      $CAMPING_4b->setParent($this->getReference('camping-4'));
      ...
      $CAMPING_4b->setMeritBadge($this->getReference('camping'));
      $CAMPING_4b->setParent($this->getReference('camping-4'));
