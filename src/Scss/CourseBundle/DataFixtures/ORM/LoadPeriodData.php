<?php
  ...
  abstract class LoadPeriodData extends AbstractFixture implements OrderedFixtureInterface {
    public function load(ObjectManager $manager) {
      ...
      $H_WK1_P1->setWeek($manager->merge($this->getReference('ch-w1')));
      ...
      $H_WK1_P2->setWeek($manager->merge($this->getReference('ch-w1')));
      ...
      $H_WK1_P3->setWeek($manager->merge($this->getReference('ch-w1')));
      ...
      $H_WK1_P4->setWeek($manager->merge($this->getReference('ch-w1')));
      ...
      $H_WK1_P5->setWeek($manager->merge($this->getReference('ch-w1')));
      ...
      $H_WK1_P6->setWeek($manager->merge($this->getReference('ch-w1')));
      ...
      $H_WK1_ME->setWeek($manager->merge($this->getReference('ch-w1')));
