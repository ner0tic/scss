...
class AttendeeEnrollment {
  ...
  private $updated;   
     ...
     * Set attendee
     *
     * @param Scss\CourseBundle\Entity\Attendee $attendee
     * @return AttendeeEnrollment
     */
    public function setAttendee(\Scss\CourseBundle\Entity\Attendee $attendee = null)
    {
     ...
     * Get attendee
     *
     * @return Scss\CourseBundle\Entity\Attendee 
     */
